      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden lg:flex space-x-6 xl:space-x-8 items-center">
            ...
            <a href="https://cdt.junpgle.me/" target="_blank" rel="noreferrer" className="text-indigo-600 hover:text-indigo-800 font-bold transition-colors duration-300 text-sm xl:text-base">网页版 Beta</a>
          ...
          <div className="lg:hidden flex items-center gap-4">
            <a href="https://cdt.junpgle.me/" target="_blank" rel="noreferrer" className="text-indigo-600 font-bold text-sm">Web Beta</a>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-2xl border-b border-slate-200 shadow-xl absolute w-full transition-all">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4 pb-2 px-2 flex flex-col gap-3">
              <a href="https://cdt.junpgle.me/" target="_blank" rel="noreferrer" onClick={() => setMobileMenuOpen(false)} className="w-full text-center bg-indigo-50 text-indigo-700 border border-indigo-100 py-3.5 rounded-xl font-bold">在线体验 Web Beta</a>
