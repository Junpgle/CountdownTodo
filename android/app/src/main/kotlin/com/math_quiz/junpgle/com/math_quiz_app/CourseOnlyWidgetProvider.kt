...
class CourseOnlyWidgetProvider : HomeWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val appWidgetIds = intent.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS)
            ?: appWidgetManager.getAppWidgetIds(ComponentName(context, CourseOnlyWidgetProvider::class.java))
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            val serviceIntent = Intent(context, CourseOnlyWidgetService::class.java).apply {
