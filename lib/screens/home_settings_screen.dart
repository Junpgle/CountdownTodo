...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void _handleInitialTarget(String target) {
    ...
    if (accountTargets.contains(target)) {
      ...
      paneId = 'preference';
      paneBuilder =
          () => PreferenceSettingsPage(initialTarget: target, isEmbedded: true);
      ...
      paneId = 'platform';
      paneBuilder = () =>
          PlatformSpecificSettingsPage(initialTarget: target, isEmbedded: true);
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      if (_selectedPaneId != 'account') {
                        setState(() {
                          _selectedPaneId = 'account';
                          _selectedRightPaneBuilder =
                              _buildAccountAndAnnouncementsPane;
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _selectedPaneId == 'account'
                            ? theme.colorScheme.primary.withValues(alpha: 0.1)
                            : (isDark ? Colors.white10 : Colors.white),
                        borderRadius: BorderRadius.circular(12),
                        border: _selectedPaneId == 'account'
                            ? Border.all(
                ...
                _buildMacSidebarItem(
                  ...
                  title: '系统与外观',
                  widgetBuilder: () =>
                      const PreferenceSettingsPage(isEmbedded: true),
                ),
                _buildMacSidebarItem(
                  id: 'animation',
                  ...
                  title: '动画与特效',
                  widgetBuilder: () =>
                      const AnimationSettingsPage(isEmbedded: true),
                ),
                _buildMacSidebarItem(
                  id: 'course',
                  icon: Icons.school,
                  ...
                  title: '课表与学期',
                  widgetBuilder: () =>
                      const CourseSettingsPage(isEmbedded: true),
                ),
                _buildMacSidebarItem(
                  id: 'interconnect',
                  icon: Icons.devices,
              ...
              child: AnimatedSwitcher(
                ...
                child: Navigator(
                  ...
                  onGenerateRoute: (settings) {
                    return PageTransitions.material(
                      settings: const RouteSettings(name: '/'),
                      builder: (context) {
                        return _selectedRightPaneBuilder?.call() ??
                            const Center(child: Text('请在左侧选择设置项'));
                      },
                    );
                  },
                ),
